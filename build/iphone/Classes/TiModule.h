...
/**
 The base class for all BgooAppi modules
 */
...
/**
 BgooAppi Platform calls this method on startup.
 */
-(void)startup;

/**
 BgooAppi Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 BgooAppi Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 BgooAppi Platform calls this method on resume.
 @param sender The sender of the event.
 */
