...
// in simulator we redefine to format for BgooAppi Developer console
...
{\
	NSString * exceptionName = [@"org.bgooappi." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bgooappi";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIBgooAppiNativeItemNone = -1, 
	UIBgooAppiNativeItemSpinner = -2,
	UIBgooAppiNativeItemProgressBar = -3,
	
	UIBgooAppiNativeItemSlider = -4,
	UIBgooAppiNativeItemSwitch = -5,
	UIBgooAppiNativeItemMultiButton = -6,
	UIBgooAppiNativeItemSegmented = -7,
	
	UIBgooAppiNativeItemTextView = -8,
	UIBgooAppiNativeItemTextField = -9,
	UIBgooAppiNativeItemSearchBar = -10,
	
	UIBgooAppiNativeItemPicker = -11,
	UIBgooAppiNativeItemDatePicker = -12,
	
	UIBgooAppiNativeItemInfoLight = -13,
	UIBgooAppiNativeItemInfoDark = -14,
	
	UIBgooAppiNativeItemDisclosure = -15,
	
	UIBgooAppiNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BgooAppi instances of
