 ...
 * Copyright (c) 2009-2011 by BgooAppi, Inc. All Rights Reserved.
...
//@interface BgooAppiObject : NSObject
//@end

@interface BgooAppiObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BgooAppiObject class]])
		{
			for (NSString *key in [[(BgooAppiObject*)o modules] allKeys])
			{
